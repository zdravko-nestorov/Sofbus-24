...
public class TranslatorCyrillicToLatin {
	 ...
	 */
	public static String[] translate(String[] arrayToTranslate) {
		String[] output = null;
		...
		if (arrayToTranslate != null && arrayToTranslate.length != 0) {
			...
			for (int i = 0; i < arrayToTranslate.length; i++) {
				output[i] = translate(arrayToTranslate[i]);
			}
		}
	 ...
	 */
	public static ArrayList<String> translate(ArrayList<String> listToTranslate) {
		...
		if (listToTranslate != null && listToTranslate.size() != 0) {
			...
			for (int i = 0; i < listToTranslate.size(); i++) {
				output.add(translate(listToTranslate.get(i)));
			}
		}
