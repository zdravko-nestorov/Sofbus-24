...
public class Constants {
	 ...
	 */
	public static final String STATION_SCHEDULE_URL = "http://schedules.sofiatraffic.bg/metro/1#sign/%s/%s";

	public static final String METRO_REGEX_STATION_SCHEDULE_PARTS = "<div class=\"schedule_view_direction\">";;
