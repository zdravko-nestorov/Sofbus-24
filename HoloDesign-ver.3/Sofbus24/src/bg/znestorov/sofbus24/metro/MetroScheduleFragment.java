...
public class MetroScheduleFragment extends ListFragment {
	...
	public static MetroScheduleFragment newInstance(
		...
		bundle.putSerializable(Constants.BUNDLE_METRO_SCHEDULE, metroScheduleEntity);
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		if (metroScheduleEntity.isActive()) {
			int currentScheduleIndex = metroScheduleEntity.getCurrentScheduleIndex();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		metroArrayAdapter = new MetroScheduleAdapter(context, metroScheduleEntity);
