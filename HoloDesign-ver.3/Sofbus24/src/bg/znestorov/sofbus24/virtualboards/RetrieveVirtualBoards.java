...
public class RetrieveVirtualBoards {
	...
	private List<BasicNameValuePair> assignHttpPostParameters(
		...
		result.addAll(Arrays.asList(
				...
				new BasicNameValuePair(Constants.VB_URL_SUBMIT, "œÓ‚ÂË")));
	...
	/**
	 * Make some adjusmtents in the special cases (([1137, 1138 - Õƒ -ÚÛÌÂÎ],
	 * [1139 - Õƒ -√‡ÙËÚË])) - replace the original station numbers with the
	 * closest ones
	 * 
	 * @param station
	...
	/**
	 * Revert the adjusmtents in the special cases (([1137, 1138 - Õƒ -ÚÛÌÂÎ],
	 * [1139 - Õƒ -√‡ÙËÚË])) - replace the closest station numbers with the
	 * original ones
	 * 
	 * @param station
	 *            the station used for searching
