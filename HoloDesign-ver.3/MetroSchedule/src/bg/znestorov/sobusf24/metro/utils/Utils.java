...
public class Utils {
	...
	public static String formatDirection(String name) {
		...
		if ("ì.Ëåòèùå Ñîôèÿ-ì.Îáåëÿ-ì.Äæåéìñ Áàó÷åğ".equals(name)
				|| "ì.Áèçíåñ Ïàğê-ì.Îáåëÿ-ì.Äæåéìñ Áàó÷åğ".equals(name)) {
			formattedName = "ì.Ìëàäîñò 1-ì.Îáåëÿ-ì.Äæåéìñ Áàó÷åğ";
		} else if ("ì.Äæåéìñ Áàó÷åğ-ì.Îáåëÿ-ì.Ëåòèùå Ñîôèÿ".equals(name)
				|| "ì.Äæåéìñ Áàó÷åğ-ì.Îáåëÿ-ì.Áèçíåñ Ïàğê".equals(name)) {
