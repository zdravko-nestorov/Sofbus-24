...
public class VehicleNames {
	...
	public VehicleNames(Context context) {
		...
		bus_stations = context.getResources().getStringArray(R.array.bus_stations);
		trolley_number = context.getResources().getStringArray(R.array.trolley_numbers);
		trolley_stations = context.getResources().getStringArray(
				R.array.trolley_stations);
		tram_number = context.getResources().getStringArray(R.array.tram_numbers);
		tram_stations = context.getResources().getStringArray(R.array.tram_stations);
